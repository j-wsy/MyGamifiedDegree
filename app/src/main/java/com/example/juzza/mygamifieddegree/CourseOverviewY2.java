...
public class CourseOverviewY2 extends AppCompatActivity implements Term1Y2.OnFragmentInteractionListener, Term2Y2.OnFragmentInteractionListener,Term3Y2.OnFragmentInteractionListener{
    Toast toast;
    TabLayout tabLayout;
    static int position;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_overview2);
